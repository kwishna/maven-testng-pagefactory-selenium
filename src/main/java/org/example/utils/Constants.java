...
public interface Constants {
    ...
    String YES = "yes";
    String NO = "no";
    int EXPLICIT_WAIT = Integer.parseInt(System.getProperty("EXPLICIT_WAIT", "30"));
    int IMPLICIT_WAIT = Integer.parseInt(System.getProperty("IMPLICIT_WAIT", "10"));
    ...
    String FIREFOX_DRIVER_PATH = System.getProperty("FIREFOX_DRIVER_PATH", PROJECT_PATH + "/drivers/geckodriver.exe");
    String EDGE_DRIVER_PATH = System.getProperty("EDGE_DRIVER_PATH", PROJECT_PATH + "/drivers/msedgedriver.exe");
    String IE_DRIVER_PATH = System.getProperty("IE_DRIVER_PATH", PROJECT_PATH + "/drivers/IEDriverServer.exe");
